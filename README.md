...
- Integrations with other plugins (e.g. `ensure_conform_formatters`)
- Extension-based configuration in `by_group`
- LSP auto-enable by file extension
...
```
> [!NOTE]
> The `integrations` option is not implemented yet and will trigger a notification.
